...
class MockPostRepository implements PostRepository {
  ...
  @override
  Future<void> createPost(Post post) async => await Future.delayed(const .new(seconds: 1));

  @override
  Future<void> updatePost(Post post) async => await Future.delayed(const .new(seconds: 1));

  @override
  Future<void> deletePost(String postId) async => await Future.delayed(const .new(seconds: 1));
}
