...
class MockUserRepository implements UserRepository {
  ...
  @override
  Future<void> createUser(UserModel user) async => await Future.delayed(const .new(seconds: 1));

  @override
  Future<void> updateUser(UserModel user) async => await Future.delayed(const .new(seconds: 1));

  @override
  Future<void> deleteUser(String userId) async => await Future.delayed(const .new(seconds: 1));
}
