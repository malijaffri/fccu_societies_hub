...
class MockCommentRepository implements CommentRepository {
  ...
  @override
  Future<void> createComment(Comment comment) async => await Future.delayed(const .new(seconds: 1));

  @override
  Future<void> updateComment(Comment comment) async => await Future.delayed(const .new(seconds: 1));

  @override
  Future<void> deleteComment(String commentId) async => await Future.delayed(const .new(seconds: 1));
}
