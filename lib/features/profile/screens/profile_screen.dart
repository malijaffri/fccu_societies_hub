  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [IconButton(icon: const Icon(Icons.settings_rounded), onPressed: () => context.push('/settings'))],
      ),
      body: userAsync.when(
        data: (user) {
          if (user == null) {
              ...
              children: [
                ...
                ListTile(
                  ...
                  onTap: () => ScaffoldMessenger.of(
                    context,
                  ).showSnackBar(const SnackBar(content: Text('Edit profile feature coming soon'))),
                ),
                ListTile(
